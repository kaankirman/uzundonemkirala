...
const page = () => {
  return (
    <div className="h-full w-full">
      <div className="flex flex-col w-full h-full bg-gradient-to-b from-orange-50 to-orange-200 px-60 pt-32 pb-4 items-center justify-center text-xl *:mb-3 overflow-hidden">
        <h1>
          ...
          standartları çerçevesinde hizmet sunmaktır. Sektördeki deneyimimiz ve
          profesyonel yaklaşımımızla, müşterilerimizin beklentilerini
        ...
        <h1>
          ...
          esnek kiralama seçeneklerimiz ile her türlü ihtiyaca cevap verebilecek
          kapasitedeyiz. İş ortaklarımızın ve bireysel müşterilerimizin
        ...
        <h1>
          ...
          kalmıyor, aynı zamanda müşterilerimizin iş verimliliğini artırmalarına
          yardımcı olacak stratejik çözümler de sunuyoruz. Yenilikçi
          yaklaşımlarımız ve sürekli gelişim anlayışımız ile sektörde öncü
          olmayı sürdüreceğiz.
        </h1>
        <h1>
